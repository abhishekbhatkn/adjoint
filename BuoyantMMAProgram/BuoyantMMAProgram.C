...
public:
	...
	transportProperties(transportProperties),
        ...
        rhoMax("rhoMax", dimDensity, GREAT, simple.dict()),
        rhoMin("rhoMin", dimDensity, Zero, simple.dict()),
        DTs(transportProperties.lookup("DTs")),
        DTf(transportProperties.lookup("DTf")),
